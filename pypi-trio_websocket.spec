...
Source0  : https://files.pythonhosted.org/packages/d1/3c/8b4358e81f2f2cfe71b66a267f023a91db20a817b9425dd964873796980a/trio_websocket-0.12.2.tar.gz
...
%prep
%setup -q -n trio_websocket-0.12.2
cd %{_builddir}/trio_websocket-0.12.2
pushd ..
cp -a trio_websocket-0.12.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740496933
...
cp %{_builddir}/trio_websocket-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-trio_websocket/694bd0afdd8360a159776129986bc45ad2f3c374 || :
